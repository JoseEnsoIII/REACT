...
`,ft=N.div`
  ...
  font-size:30px;
  color:white;
`;class k extends d.Component{constructor(o){super(o);y(this,"addCurrent",()=>{const{images:o,loop:t}=this.props,{currentId:n}=this.state,e=n+1;e<o.length?this.setState({currentId:e,key:Date.now()}):t&&this.setState({currentId:0,key:Date.now()})});y(this,"subCurrent",()=>{const{images:o,loop:t}=this.props,{currentId:n}=this.state,e=n-1;e>=0?this.setState({currentId:e,key:Date.now()}):t&&this.setState({currentId:o.length-1,key:Date.now()})});this.state={currentId:0}}render(){let t=(this.props.images||[])[this.state.currentId];return t?c.jsxs(pt,{className:"carousel",children:[c.jsx("div",{className:"carousel-main",alt:"",children:c.jsx(lt,{children:c.jsx(ut,{timeout:500,children:c.jsx(ct,{src:t,alt:t})},this.state.currentId)})}),c.jsx(dt,{onClick:this.subCurrent,children:c.jsx(B,{})}),c.jsx(ft,{onClick:this.addCurrent,children:c.jsx(Y,{})})]}):null}}k.propTypes={images:T.array.isRequired,thumb:T.bool,loop:T.bool,autoplay:T.number};k.defaultProps={images:[],thumb:!0,loop:!0};class ht extends d.Component{constructor(i){super(i),this.state={hasError:!1}}static getDerivedStateFromError(i){return{hasError:!0}}componentDidCatch(i,o){console.error("Error caught by ErrorBoundary:",i,o)}render(){return this.state.hasError?c.jsx("h1",{children:"Something went wrong. Please try again later."}):this.props.children}}function mt(){const r=["https://img.sflix.to/xxrz/1200x600/224/a5/c1/a5c1674ed733c43933cd11e877f050b5/a5c1674ed733c43933cd11e877f050b5.jpg","/images/bb.jpg","/images/meg2.jpg"];return c.jsx(ht,{children:c.jsx(k,{images:r})})}const xt=N.div`
  height: 150%; /* Tailwind classes can be used directly here */
`,jt=()=>c.jsxs(xt,{children:[c.jsx(q,{}),c.jsx(mt,{}),c.jsx(z,{}),c.jsx(H,{})]});export{jt as default};
